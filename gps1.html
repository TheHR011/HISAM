...
<body>
    ...
    <script>
        ...
        const carIcon = L.icon({
			      ...
			      iconUrl: 'https://e7.pngegg.com/pngimages/361/692/png-clipart-motorcycle-helmets-computer-icons-super-bike-logo-motorcycle.png',
            iconSize: [20, 38], // Size of the icon (width, height)
        ...
        // MQTT Client Setup
        // GANTI PAKE AKUN MQTT, ini contoh gratis
		//#const client = mqtt.connect('wss://test.mosquitto.org:8081/mqtt', {
		const client = mqtt.connect('wss://broker.hivemq.com:8884/mqtt', {	
		username: '', // kalau ada di isi
		password: '', // kalau ada di isi
        ...
        client.on('connect', () => {
            ...
            client.subscribe('car/gps082', (err) => { //<<<<<<<<UBAH TOPIK INI 'car/gps'
                if (!err) {
                    console.log('Subscribed to car/gps082 topic');
                }
            });
        });
